...
<div class="description-product" id="<?=$arItemIDs['ID']?>">
    ...
    <span class="availability" itemprop="availability" href="http://schema.org/InStock"><?=GetMessage("WF_AVAIL_STATUS")?>:
		<?if($canBuy):?>
		...
		<div class="share-article-block" style="text-align:center;">
	...
	<div class="description-text">
		...
		<div class="gallery-vertical-hold" id="<?= $arItemIDs['BIG_SLIDER_ID']?>">
			...
			<div class="visual" id="<?= $arItemIDs['BIG_IMG_CONT_ID']; ?>">
				<img itemprop="image" id="<?= $arItemIDs['PICT']?>" class="" src="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>" alt="<?=$arResult["NAME"]?>">
			</div>
		</div>
	</div>
</div>
