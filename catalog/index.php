  ...
  <div class="container">
	...
	array(
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			11 => "SHAPE_BATH",
			12 => "LENGTH_BATH",
			13 => "TYPE_SHOWER_SYSTEM",
			14 => "TYPE_SYSTEM",
			15 => "HAVING_CEILING_SHOWER",
			16 => "AVAILABILITY_THERMOSTAT",
			17 => "TYPE_FURNITURE",
			18 => "PURPOSE_MIXER",
			19 => "RETRACTABLE_SHOWER",
			20 => "HYGIENIC_SHOWER",
			21 => "BOTTOM_VALVE",
			22 => "CONTROL_TYPE_MIXER",
			23 => "INSTALLATION_TYPE_MIXER",
			24 => "TYPE_INSTALLATION_KITCHEN",
			25 => "MATERIAL_KITCHEN_SINK",
			26 => "FORM_KITCHEN_SINK",
			27 => "NUMBER_BOWLS_KITCHEN_SINK",
			28 => "WIDTH_SINK",
			29 => "WIDTH_FURNITURE",
			30 => "DEPTH_CLEANING",
			31 => "INSTALLATION_TYPE_TOILET",
			32 => "RELEASE_TYPE_TOILET",
			33 => "APPOINTMENT_ACCESSORY",
			34 => "TYPE_SCOPE",
			35 => "AVAILABILITY_MIXER",
			36 => "MATERIAL",
			37 => "",
		),
